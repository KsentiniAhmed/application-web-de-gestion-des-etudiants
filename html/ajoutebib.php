...
$ajout = false;
if(isset($_POST['titre'],$_POST['auteur'],$_POST['commentaire'])){
...
$sql = "INSERT INTO `bibliotheque`(`id_livre`, `titre`, `auteur`, `commentaire`) VALUES (NULL, '$titre', '$auteur','$commentaire');";
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        ...
        <li><a href="affbib.php">Bibliothéque</a></li>
         <li>  <a href="affbib.php">Afficher livres</a></li>
...
<a href="affbib.php">Afficher livres</a>
...
<table>
	...
	<tr>
		...
		<td><button type="submit">Ajouter livre</button></td>
